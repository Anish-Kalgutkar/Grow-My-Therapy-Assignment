      ...
      <div className="mx-auto max-w-2xl px-6">
        <div className="bg-white p-8 md:p-12 rounded-3xl shadow-2xl border border-purple-100">
          <div className="text-center mb-10">
            <h2 className="text-3xl font-bold text-purple-900 mb-2">Book Your Free Consultation</h2>
            <p className="text-slate-600">Fill out the details below and I'll get back to you within 24 hours.</p>
          </div>
          ...
          <form className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              {/* Email */}
              <div>
                <label className="block text-sm font-semibold text-purple-900 mb-2">Email Address *</label>
                <input 
                  required
                  type="email" 
            ...
            {/* Service Selection */}
            <div>
              <label className="block text-sm font-semibold text-purple-900 mb-2">What are you looking for? *</label>
              <select required className="w-full px-4 py-3 rounded-xl border border-purple-200 focus:ring-2 focus:ring-purple-500 outline-none appearance-none bg-white">
            ...
            {/* Message */}
            <div>
              <label className="block text-sm font-semibold text-purple-900 mb-2">Briefly, what’s been weighing on you? *</label>
              <textarea 
                required
                rows={4}
