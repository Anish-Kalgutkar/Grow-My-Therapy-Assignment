...
- This repository contains only source code (no `node_modules` or build files)
- AI tools were used responsibly for ideation and refinement
- All final decisions, styling, and copy were manually reviewed and customized

---

## 👤 Candidate

**Name:** Anish Kalgutkar  
**Role Applied For:** Front-End Developer Intern  
**Assignment Stage:** Stage 2 – Practical Skill Evaluation
